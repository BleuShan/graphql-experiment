...
const env = process.env.MIX_ENV || process.env.NODE_ENV
...
const config = {
  devtool: !isDeveloppement ? undefined : 'cheap-module-eval-source-map',
  entry: entries,
  output: {
    path: outputPath,
  ...
  resolve: {
    alias: {
      'hyperscript-helpers/svg': 'hyperscript-helpers/src/svg'
    },
    extensions: [
      ' ',
      '.js',
